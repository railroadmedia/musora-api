...
class SetCustomDecorators
{
    ...
    public function handle($request, Closure $next)
    {
        $allDecoratorsForContent =
            array_merge(ConfigService::$decorators['content'], [DateFormatDecorator::class, StripTagDecorator::class]);

        $allDecoratorsForComment =
            array_merge(ConfigService::$decorators['comment'], [StripTagDecorator::class]);
